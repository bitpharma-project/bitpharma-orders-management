...
export const ApiServer = process.env.NODE_ENV === 'development' ? 'http://0.0.0.0:3000/api' : 'http://api.bitpharma.xyz/api';
export const WSConnection = process.env.NODE_ENV === 'development' ? 'ws://0.0.0.0:3000' : 'ws://api.bitpharma.xyz';
export const Server = process.env.NODE_ENV === 'development' ? 'http://0.0.0.0:3000' : 'http://api.bitpharma.xyz';
